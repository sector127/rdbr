                ...
                <Link href="?auth=profile" scroll={false}>
                  {user?.avatar ? (
                    <Image
                      ...
                      width={56}
                      height={56}
                      className="aspect-square object-cover rounded-full border border-gray-200 dark:border-gray-800 hover:ring-2 hover:ring-indigo-500 transition-all cursor-pointer"
                    />
                  ) : (
                    <Image src="/icons/AvatarFallback.svg" alt="Avatar" width={40} height={40} className="dark:invert" />
                  )}
                </Link>
