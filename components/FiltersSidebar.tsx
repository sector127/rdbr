...
export function FiltersSidebar({
  ...
  return (
    <div className="w-full md:w-64 flex-shrink-0 flex flex-col pt-2">
        ...
        <div className="flex flex-wrap gap-2.5">
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                {cat.icon && <span className={isSelected ? "text-indigo-600 dark:text-indigo-400" : "text-zinc-400"}>{cat.icon}</span>}
                {cat.name}
              </button>
            );
          })}
