...
export function HeroBanner() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 p-8 md:p-14 lg:p-20 flex flex-col items-start">
      ...
      <div className="absolute bottom-[59px] right-[78px] z-20 flex gap-3">
        <button 
          ...
          className={`flex h-10 w-10 items-center justify-center rounded-full border border-white/40 text-white transition-colors backdrop-blur-sm ${currentIndex === 0 ? 'opacity-30 cursor-not-allowed bg-black/10' : 'hover:bg-white/20 bg-black/20'}`} 
        ...
        <button 
          ...
          className={`flex h-10 w-10 items-center justify-center rounded-full border border-white/40 text-white transition-colors backdrop-blur-sm ${currentIndex === HERO_IMAGES.length - 1 ? 'opacity-30 cursor-not-allowed bg-black/10' : 'hover:bg-white/20 bg-black/20'}`} 
